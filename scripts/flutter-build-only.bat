...
REM ==========================================
REM WellFin Flutter APK Builder (Build Only)
REM ==========================================
...
call flutter build apk --release --build-name=!VERSION! --dart-define=WELLFIN_API_KEY=!API_KEY! --dart-define=WELLFIN_API_URL=!API_URL!
